...
if(isset($_POST['update_bpnt'])){
    $nik = $_POST['nik'];
    $sql_update_bantuan = $mysqli->query("UPDATE tabel_kependudukan SET bantuan='1', jenis_bantuan = 'BPNT', jenis_bantuan = 'diproses' WHERE NIK = '$nik'");
    echo '
    <script>
...
if(isset($_POST['update_pkh'])){
    $nik = $_POST['nik'];
    $sql_update_bantuan = $mysqli->query("UPDATE tabel_kependudukan SET bantuan='1', jenis_bantuan = 'PKH', jenis_bantuan = 'diproses' WHERE NIK = '$nik'");
    echo '
    <script>
...
if(isset($_POST['update_bst'])){
    $nik = $_POST['nik'];
    $sql_update_bantuan = $mysqli->query("UPDATE tabel_kependudukan SET bantuan='1', jenis_bantuan = 'BST', jenis_bantuan = 'diproses' WHERE NIK = '$nik'");
    echo '
    <script>
...
if(isset($_POST['update_blt'])){
    $nik = $_POST['nik'];
    $sql_update_bantuan = $mysqli->query("UPDATE tabel_kependudukan SET bantuan='1', jenis_bantuan = 'BLT', jenis_bantuan = 'diproses' WHERE NIK WHERE NIK = '$nik'");
    echo '
    <script>
...
if(isset($_POST['terima_bansos'])){
    $nik = $_POST['nik'];
    $update = $mysqli->query("UPDATE tabel_Kependudukan SET  jenis_bantuan = 'diambil',bantuan='0' WHERE NIK = '$nik'");
    $update = $mysqli->query("UPDATE daftar_bansos SET  jenis_bantuan = 'diambil' WHERE NIK = '$nik'");
    echo '
    <script>
    alert("bantuan sudah diberikan");
    document.location.href="data_klasifikasi_bantuan";
    </script>
    ';
